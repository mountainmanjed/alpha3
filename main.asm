...
loc_004980:
	...
	jsr loc_01fc54
	jsr loc_01fc70
	move.b #1,(W_Cps0_Start,a5)
	move.b #1,(W_Cps1_Start,a5)
	move.b #1,(W_Cps2_Start,a5)
	move.w #3,($102,a5)
...
loc_005a2c:
	...
	move.w (-$7176,a5),d0
	lea (W_Cps0_Start,a5),a0
	lea (-$7128,a5),a1
	bsr.b loc_005a84
	lea (W_Cps1_Start,a5),a0
	lea (-$70f8,a5),a1
	bsr.b loc_005a84
	lea (W_Cps2_Start,a5),a0
	lea (-$70c8,a5),a1
