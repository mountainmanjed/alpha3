...
loc_06654c:
	move.b loc_066574(pc,d0.w),(pl_invinciblity_timer,a6)
	move.b ($82,a6),d0
	lsl.w #2,d0
...
loc_0666f6:
	move.b loc_0666fe(pc,d0.w),(pl_invinciblity_timer,a6)
...
loc_06716e:
	move.b loc_06717a(pc,d0.w),(pl_invinciblity_timer,a6)
	clr.b ($216,a6)
