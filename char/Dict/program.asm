...
loc_048160:
	move.b loc_04818c(pc,d0.w),(pl_invinciblity_timer,a6)
	rts
...
loc_048372:
	move.b loc_0483a0(pc,d0.w),(pl_invinciblity_timer,a6)
	rts
...
loc_04850a:
	move.b loc_048512(pc,d0.w),(pl_invinciblity_timer,a6)
...
loc_048892:
	move.b #6,(7,a6)
	move.b #$3e,($2a0,a6)
	move.b #8,(pl_invinciblity_timer,a6)
	moveq #$1c,d0
	jmp loc_02a758
...
loc_048d3c:
	...
	move.l d0,($1c2,a6)
	move.l d0,(pl_inp_slot_2,a6)
	move.l d0,($192,a6)
	move.l d0,(pl_inp_slot_5,a6)
	move.l d0,($1aa,a6)
	move.l d0,(pl_inp_slot_6,a6)
	move.l d0,($1b2,a6)
