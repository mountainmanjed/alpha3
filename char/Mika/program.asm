...
loc_06243c:
	lea (pl_inp_slot_7,a6),a4
	jsr SpInp_720RotP_code
	bne.w loc_0626fc

loc_06244a:
	lea (pl_inp_slot_5,a6),a4
...
loc_062474:
	lea (pl_inp_slot_0,a6),a4
	jsr SpInp_23623K_code
	bne.w loc_062612

loc_062482:
	lea (pl_inp_slot_1,a6),a4
	jsr SpInp_214P_code
	bne.w loc_06252a

loc_062490:
	lea (pl_inp_slot_4,a6),a4
	jsr SpInp_214K_code
	bne.w loc_06267c

loc_06249e:
	lea (pl_inp_slot_3,a6),a4
	jsr SpInp_63214K_Code
	bne.w loc_062644

loc_0624ac:
	lea (pl_inp_slot_a,a6),a4
...
loc_062b56:
	move.b loc_062b5e(pc,d0.w),(pl_invinciblity_timer,a6)
...
loc_062c88:
	...
	tst.b ($31,a4)
	bne.b loc_062c84
	cmpi.w #$70,(pl_dist_away,a6)
	bcc.b loc_062c84
	tst.b ($2c8,a4)
	beq.b loc_062cac
	cmpi.w #$50,(pl_dist_away,a6)
	bcc.b loc_062c84
	moveq #$c,d2
	bra.b loc_062c80
...
loc_063e58:
	move.b loc_063e60(pc,d0.w),(pl_invinciblity_timer,a6)
